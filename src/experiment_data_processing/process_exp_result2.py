...
file_name = '../../scripts/output_heartbeat_feature_errors'
...
if __name__ == '__main__':
    ...
    #     training_time_labels = [training_time_label, training_time_standard_lib_label, training_time_iteration_label, training_time_closed_form_label, training_time_linview_label, training_time_provenance_label, training_time_provenance_label, training_time_iteration_label,training_time_iteration_label, training_time_iteration_label, training_time_iteration_label]
        ...
        labels = [origin_label, iteration_label, provenance_label, provenance_opt_label]
         
        start_prefixes = [start_iteration_label, start_provenance_label, start_provenance_opt_label, start_influence_function]
         
        training_time_labels = [training_time_label, training_time_iteration_label, training_time_provenance_label, training_time_provenance_label]
