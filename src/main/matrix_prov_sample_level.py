...
#         self.name = name
#         
#         prov_list, data_matrix_list = add_prov_token(M, name, self.shape, partition)
#         
#         '''list of list'''
#         self.prov_list = prov_list
#         
...
#         self.supple_matrix_list2 = supple_matrix_list2
    ...
    def add_prov_token_constants(M, shape, by_row = True):
    ...
    def add_prov_token(M, name, shape, by_row = True):
...
#         
#         assert shape1[1] == shape2[0]
        sub_shape1 = list(P1.data_matrix_list[0][0].size())
        sub_shape2 = list(P2.data_matrix_list[0][0].size())
    ...
    #             for j in range(len(P2.data_matrix_list)):
            ...
            return M_prov(res, final_data_matrix, final_prov_list)
    
    
    def constant_mul_prov_matrix(P1, P2, res):
        if len(P2.data_matrix_list) == 1 and list(P2.data_matrix_list[0][0].size()) == [1,1]:
            P = P1
            P1 = P2
            P2 = P
        else:
            assert len(P1.data_matrix_list) == 1 and list(P1.data_matrix_list[0][0].size()) == [1,1]
...
#             for j in range(len(P2.data_matrix_list[0])):
            curr_data_matrix_list = P2.data_matrix_list[i]
            curr_prov_list = P2.prov_list[i]
                
            res_data_matrix_list = []
            res_prov_list = []
            
            if list(curr_data_matrix_list[0].size())[0] == 1:
                M_prov.sub_matrix_mul_with_prov(P1.data_matrix_list[0], curr_data_matrix_list, P1.prov_list[0], curr_prov_list, res_prov_list, res_data_matrix_list)
            
            else:
                M_prov.sub_matrix_mul_with_prov(curr_data_matrix_list, P1.data_matrix_list[0], curr_prov_list, P1.prov_list[0], res_prov_list, res_data_matrix_list)
            
            
            
            
        
            prov_list.append(res_prov_list)
            data_matrix_list.append(res_data_matrix_list)
