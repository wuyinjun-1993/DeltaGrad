...
# from noworkflow.now.collection.prov_definition.ast_elements import none
prov_one = "1"
prov_zero = "0"
...
class M_prov(object):
    ...
    def __init__(self, M, data_matrix_list, prov_list, prov_exponent_list):
        self.M = M
        self.data_matrix_list = data_matrix_list
        self.prov_list = prov_list
        self.prov_exponent_list = prov_exponent_list
    ...
    def add_prov_token_constants(M, shape):
        ...
        for i in range(shape[0]):
            ...
            for j in range(shape[1]):
                ...
                curr_exponent = []
                unique_id = prov_one
                curr_prov.append(unique_id)
                curr_exponent.append(1)
                curr_prov_list = []
                curr_exponent_list = []
                curr_prov_list.append(curr_prov)
                curr_exponent_list.append(curr_exponent)
                
                
                this_prov_list.append(curr_prov_list)
                this_prov_exponent_list.append(curr_exponent_list)
            ...
            prov_exponent_list.append(this_prov_exponent_list)


        return M_prov(M, data_matrix_list, prov_list, prov_exponent_list)
...
#                 start = partition[i]
    ...
    def prov_matrix_transpose(P, res):
        ...
        prov_exponent_list = list(map(list, zip(*P.prov_exponent_list)))
...
#             data_matrix_list.append(curr_data_matrix_list)
        ...
        return M_prov(res, data_matrix_list, prov_matrix_list, prov_exponent_list)
    ...
    def prov_matrix_add_prov_matrix(P1, P2, res):
        ...
        for i in range(shape11):
            ...
            for j in range(shape12):
                ...
                curr_prov_exponent_list1 = P1.prov_exponent_list[i][j]
                curr_prov_exponent_list2 = P2.prov_exponent_list[i][j]
                ...
                curr_prov_list = []
                curr_data_matrix_list = []
                curr_prov_exponent_list = []
                curr_prov_list.extend(curr_prov_list1)
                curr_prov_exponent_list.extend(curr_prov_exponent_list1)
...
#                         index = curr_prov_list.index(curr_prov_list2[k])
                        ...
                        indices1 = [i for i, x in enumerate(curr_prov_list) if x == curr_prov_list2[k]]
                        indices2 = [i for i, x in enumerate(curr_prov_exponent_list) if x == curr_prov_exponent_list2[k]]
                        
                        indices = [value for value in indices1 if value in indices2]
                        
#                         print('id', indices)
                        
                        if len(indices) > 0:
                            for id in range(len(indices)):
                                curr_data_matrix_list[indices[id]] = curr_data_matrix_list[indices[id]] + curr_data_matrix_list2[k]
                        
                        else:
                            curr_prov_list.append(curr_prov_list2[k])
                            curr_prov_exponent_list.append(curr_prov_exponent_list2[k])
                            curr_data_matrix_list.append(curr_data_matrix_list2[k])
                        
                
                this_prov_list.append(curr_prov_list)
                this_data_matrix_list.append(curr_data_matrix_list)
                this_prov_exponent_list.append(curr_prov_exponent_list)
            prov_list.append(this_prov_list)
            data_matrix_list.append(this_data_matrix_list)
            prov_exponent_list.append(this_prov_exponent_list)
...
#             data_matrix_list.append(curr_data_matrix_list)            
        ...
        return M_prov(res, data_matrix_list, prov_list, prov_exponent_list)
...
#             prov_list.extend(curr_prov_list)
    ...
    def prov_update(sub_prov_list1, sub_prov_list2, sub_prov_exponent_list1, sub_prov_exponent_list2, sub_prov_list, sub_prov_exponent_list):
        i = 0
        j = 0
        
        while i<len(sub_prov_list1) and j < len(sub_prov_list2):
            if sub_prov_list1[i] > sub_prov_list2[j]:
                
                if len(sub_prov_list) == 0 or (len(sub_prov_list) > 0 and sub_prov_list[-1] != sub_prov_list2[j]):
                    sub_prov_list.append(sub_prov_list2[j])
                    sub_prov_exponent_list.append(sub_prov_exponent_list2[j])
                    
                else:
                    sub_prov_exponent_list[-1] += sub_prov_exponent_list2[j]
                j = j+1
                
            else:
                if sub_prov_list1[i] < sub_prov_list2[j]:
                    if len(sub_prov_list) == 0 or (len(sub_prov_list) > 0 and sub_prov_list[-1] != sub_prov_list1[i]):
                        sub_prov_list.append(sub_prov_list1[i])
                        sub_prov_exponent_list.append(sub_prov_exponent_list1[i])
                    else:
                        sub_prov_exponent_list[-1] += sub_prov_exponent_list1[i]
                    ...
                    if len(sub_prov_list) == 0 or (len(sub_prov_list) > 0 and sub_prov_list[-1] != sub_prov_list1[i]):
                        sub_prov_list.append(sub_prov_list1[i])
                        sub_prov_exponent_list.append(sub_prov_exponent_list1[i] + sub_prov_exponent_list2[j])
                    else:
                        sub_prov_exponent_list[-1] += sub_prov_exponent_list1[i] + sub_prov_exponent_list2[j]
...
#         print('prov_list', sub_prov_list)
                
    
    '''curr_data_matrix_list1, curr_data_matrix_list2, curr_prov_list1, curr_prov_list2, curr_prov_exponent_list1, curr_prov_exponent_list2, curr_prov_list, curr_data_matrix_list, curr_prov_exponent_list'''
    
    
    def sub_matrix_mul_with_prov(sub_data_matrix_list1, sub_data_matrix_list2, sub_prov_list1, sub_prov_list2, sub_prov_exponent_list1, sub_prov_exponent_list2, prov_list, data_matrix_list, prov_exponent_list):
        for i in range(len(sub_data_matrix_list1)):
#             print('here!!!!', sub_data_matrix_list1[i])
#             print('here!!!!', sub_data_matrix_list2)
            sub_data_matrix_list1[i] = sub_data_matrix_list1[i].type(torch.FloatTensor)
            
            for j in range(len(sub_data_matrix_list2)):
                
                sub_data_matrix_list2[j] = sub_data_matrix_list2[j].type(torch.FloatTensor)
...
#                 print(sub_prov_list1[i])
                ...
                '''sub_prov_list1, sub_prov_list2, sub_prov_exponent_list1, sub_prov_exponent_list2, sub_prov_list, sub_prov_exponent_list'''
                M_prov.prov_update(sub_prov_list1[i], sub_prov_list2[j], sub_prov_exponent_list1[i], sub_prov_exponent_list2[j], curr_prov, curr_exponent)
                
#                 print('curr_exponent', curr_exponent)
#                 curr_prov.update(sub_prov_list1[i])
#                 curr_prov.update(sub_prov_list2[j])

                if len(curr_prov) > 1:
                    try:
                        index = curr_prov.index(prov_one)
                        del curr_prov[index]
                        del curr_exponent[index]
...
#                     curr_prov.discard(prov_one)
                ...
                indices1 = [i for i, x in enumerate(prov_list) if x == curr_prov]
                indices2 = [i for i, x in enumerate(prov_exponent_list) if x == curr_exponent]
...
#                         print('id', indices)
                ...
                if len(indices) > 0:
                    for id in range(len(indices)):
                        data_matrix_list[indices[id]] = torch.add(data_matrix_list[indices[id]], curr_sub_data_matrix)
#                         curr_data_matrix_list[indices[id]] = curr_data_matrix_list[indices[id]] + curr_data_matrix_list2[k]
...
#                     curr_data_matrix_list.append(curr_data_matrix_list2[k])
                    ...
                    prov_exponent_list.append(curr_exponent)
        ...
        for i in range(size1):
            ...
            for j in range(size4):
                ...
                for k in range(size3):
                    ...
                    curr_prov_exponent_list1 = P1.prov_exponent_list[i][k]
                    curr_prov_exponent_list2 = P2.prov_exponent_list[k][j]
                    
#                     print(i,j,k)
#                     print(curr_data_matrix_list1[0])
#                     print(curr_data_matrix_list2)
                    
                    M_prov.sub_matrix_mul_with_prov(curr_data_matrix_list1, curr_data_matrix_list2, curr_prov_list1, curr_prov_list2, curr_prov_exponent_list1, 
                                                    curr_prov_exponent_list2, curr_prov_list, curr_data_matrix_list, curr_prov_exponent_list)
                    
                    
#                     print('curr_prov_exponent_list', curr_prov_exponent_list)
    ...
    def constant_mul_prov_matrix(P1, P2, res):
        ...
        for i in range(len(P2.data_matrix_list)):
            ...
            for j in range(len(P2.data_matrix_list[0])):
                ...
                curr_prov_exponent_list = P2.prov_exponent_list[i][j]
                
#                 print('p2_prov_exponent_list::', curr_prov_exponent_list)
#                 print('p2_prov_matrix_list::', curr_data_matrix_list)
#                 
#                 print('p1_prov_exponent_list::', P1.prov_list)
#                 print('p1_prov_matrix_list::', P1.data_matrix_list)
                
                
                res_data_matrix_list = []
                res_prov_list = []
                res_prov_exponent_list = []
                
                '''sub_data_matrix_list1, sub_data_matrix_list2, sub_prov_list1, sub_prov_list2, sub_prov_exponent_list1, sub_prov_exponent_list2, prov_list, data_matrix_list, prov_exponent_list'''
                
                M_prov.sub_matrix_mul_with_prov(curr_data_matrix_list, P1.data_matrix_list[0][0], curr_prov_list, P1.prov_list[0][0], curr_prov_exponent_list, P1.prov_exponent_list[0][0], res_prov_list, res_data_matrix_list, res_prov_exponent_list)
            
                this_prov_list.append(res_prov_list)
                this_data_matrix_list.append(res_data_matrix_list)
                this_prov_exponent_list.append(res_prov_exponent_list)
    ...
    def negate_prov_matrix(P, res):
        ...
        for i in range(shape1):
            ...
            for j in range(shape2):
                ...
                curr_prov_exponent_list = P.prov_exponent_list[i][j]
