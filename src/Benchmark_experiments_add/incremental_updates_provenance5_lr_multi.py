...
#     res_para = torch.load(git_ignore_folder + 'res_para')
#     
#     res_grad = torch.load(git_ignore_folder + 'res_grad')
#     
#     all_res = torch.load(git_ignore_folder + 'all_res')
...
#     model_para_list = model_update_provenance_test3_multi(None, period, 1, init_epochs, None, None, exp_gradient_list_all_epochs, exp_para_list_all_epochs, dataset_train, model, grad_list_all_epoch_tensor, para_list_all_epoch_tensor, grad_list_GPU_tensor, para_list_GPU_tensor, cached_size, max_epoch, 2, learning_rate_all_epochs, random_ids_multi_super_iterations, sorted_ids_multi_super_iterations, batch_size, dim, X_to_add, Y_to_add, criterion, optimizer, lr_scheduler, regularization_coeff, is_GPU, device, all_added_random_ids_list_all_samples)
    
    model_para_list = model_update_provenance_test3_multi0(origin_train_data_size, None, period, 1, init_epochs, None, None, exp_gradient_list_all_epochs, exp_para_list_all_epochs, dataset_train, model, grad_list_all_epoch_tensor, para_list_all_epoch_tensor, grad_list_GPU_tensor, para_list_GPU_tensor, cached_size, max_epoch, 2, learning_rate_all_epochs, random_ids_multi_super_iterations, sorted_ids_multi_super_iterations, batch_size, dim, X_to_add, Y_to_add, criterion, optimizer, lr_scheduler, regularization_coeff, is_GPU, device, all_added_random_ids_list_all_samples)
