...
#     Hessin_matrix = compute_hessian_matrix_2(X, X_Y_mult, model_origin, dim, X_product)
...
#     Hessian_inverse = torch.inverse(Hessin_matrix)
    ...
    curr_X_Y_mult = X_Y_mult[selected_rows]

    first_derivative = compute_first_derivative_single_data1(curr_X_Y_mult, model_origin)
