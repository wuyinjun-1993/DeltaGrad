...
#         delta_X_Y_prod = X_Y_mult[delta_data_ids]
        ...
        sub_term_1, sub_term_2, A, B = prepare_term_1_batch2_delta1(alpha, beta, term1, term2, delta_X_product, delta_X_Y_prod, w_seq, b_seq, dim, batch_num, batch_size, delta_data_ids, mini_batch_epoch, max_epoch, cut_off_epoch,init_theta)
