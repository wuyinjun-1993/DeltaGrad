...
#     
    ...
    init_theta = Variable(initialize(X).theta)
...
#     res2, total_time = compute_model_parameter_by_iteration2(update_X_Y_mult.shape, init_theta, update_X_Y_mult, max_epoch, alpha, beta, mini_batch_epoch, selected_rows, batch_size)
    ...
    res2, total_time, theta_list, gradient_list = compute_model_parameter_by_iteration_2(random_ids_multi_super_iterations, sorted_ids_multi_super_iterations, X_Y_mult.shape, init_theta, X_Y_mult, max_epoch, alpha, beta, mini_batch_epoch, selected_rows, batch_size)
