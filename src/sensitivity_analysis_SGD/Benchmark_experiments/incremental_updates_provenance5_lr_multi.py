...
#     print("learning rate::", alpha)
    ...
    para_list_GPU_tensor = para_list_all_epoch_tensor[0:end_cached_id]
    
    grad_list_GPU_tensor = grad_list_all_epoch_tensor[0:end_cached_id]
    ...
    exp_res_para_list = torch.load(git_ignore_folder + 'exp_multi_para_list')
