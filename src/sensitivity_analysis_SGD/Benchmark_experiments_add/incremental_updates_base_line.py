...
#     added_batch_size = int(X_to_add.shape[0]*1.0/len(dataset_train)*batch_size + 0.5)
...
#     max_epoch, dataset_train, dim, model, random_ids_multi_super_iterations, batch_size, learning_rate_all_epochs, added_random_ids_multi_super_iteration, added_batch_size, X_to_add, Y_to_add, criterion, optimizer, para_list_all_epochs, gradient_list_all_epochs, is_GPU, device, record_params, regularization_coeff
    
    model, count, exp_para_list_all_epochs, exp_gradient_list_all_epochs = model_update_standard_lib(max_epoch, dataset_train, dim, model, random_ids_multi_super_iterations, batch_size, learning_rate_all_epochs, added_random_ids_multi_super_iteration, X_to_add, Y_to_add, criterion, optimizer, para_list_all_epochs, gradient_list_all_epochs, is_GPU, device, record_params, regularization_coeff)
