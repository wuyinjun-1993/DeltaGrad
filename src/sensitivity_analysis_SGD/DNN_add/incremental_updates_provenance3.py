...
#     model_para_list = model_update_provenance_test(None, None, exp_gradient_list_all_epochs, exp_para_list_all_epochs, origin_X, origin_Y, model, S_k_list, Y_k_list, gradient_list_all_epochs, para_list_all_epochs, max_epoch, delta_data_ids, input_dim, hidden_dims, output_dim, 50, alpha, beta, selected_rows, error)
    ...
    model_para_list = model_update_provenance_test1(20, 1, init_epochs, None, None, None, None, origin_X, origin_Y, model, gradient_list_all_epochs, para_list_all_epochs, max_epoch, input_dim, hidden_dims, output_dim, 2, learning_rate_all_epochs, beta, error, random_ids_multi_super_iterations, sorted_ids_multi_super_iterations, batch_size, dim, added_random_ids_multi_super_iteration, added_batch_size, X_to_add, Y_to_add)
