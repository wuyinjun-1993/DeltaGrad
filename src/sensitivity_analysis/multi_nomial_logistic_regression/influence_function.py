...
#     curr_X_Y_mult = X_Y_mult[delta_data_ids]
    ...
    first_derivative = compute_first_derivative(delta_X, delta_Y, dim, model_origin, num_class)
...
#     print('gap::', compute_first_derivative_single_data(X_Y_mult, selected_rows, expected_theta))
    ...
    print('training_accuracy::', compute_accuracy2(update_X, update_Y.type(torch.FloatTensor), updated_theta))
