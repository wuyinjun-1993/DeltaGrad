...
# from sensitivity_analysis.logistic_regression.Logistic_regression import test_X
    from General_model.utils import *
#     from sensitivity_analysis.linear_regression.evaluating_test_samples import *
    from General_model.Deep_nerual_network import *
...
#     model, count = model_update_standard_lib_stochastic(batch_size, max_epoch, update_X, update_Y, alpha, error, model)
    t1 = time.time()
    model, count = model_update_standard_lib(max_epoch, update_X, update_Y, alpha, error, model, beta)
...
#     model, gradient_list_all_epochs, output_list_all_epochs, para_list_all_epochs, epoch = model_training(max_epoch, update_X, update_Y, test_X, test_Y, alpha, beta, error, model, True)
