...
#             sub_term_1 = prepare_term_1_batch2(delta_X_product, sub_w_seq, delta_X.shape)
            ...
            res3 = compute_model_parameter_by_approx_incremental_3_2(term1, delta_X, term2 - sub_term_2, update_X.shape, init_theta, max_epoch, cut_off_epoch, alpha, beta, sub_w_seq)
        else:
