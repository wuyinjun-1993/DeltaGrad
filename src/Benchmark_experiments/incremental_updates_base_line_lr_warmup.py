...
#     from sensitivity_analysis.linear_regression.evaluating_test_samples import *
    ...
    from incremental_updates_provenance3_lr2 import *
...
#     delta_grad_tensor = torch.cat(delta_grad_list, 0)
#     
#     
#     U, S, V =torch.svd(delta_grad_tensor)
#     
#     
# #     U_list.append(U)
# #     
...
# #     V_list.append(V)
#     
#     sub_s2 = S[0:upper_bound]
#      
#  
#     sub_u2 = U[:,0:upper_bound]
#       
#      
#       
#     sub_v2 = V[:,0:upper_bound]
#     
#     approx_delta_grad = torch.mm(sub_u2*sub_s2, torch.t(sub_v2))
#     
#     print("approx_errors::", torch.norm(delta_grad_tensor -approx_delta_grad))
#     
#     print("approx_errors2::", torch.norm(delta_para_tensor -approx_delta_para2))
...
#     model, count = model_update_standard_lib_stochastic(batch_size, max_epoch, update_X, update_Y, alpha, error, model)
    t1 = time.time()
    model, count, exp_para_list_all_epochs, exp_gradient_list_all_epochs, random_ids_list_all_epochs  = model_update_standard_lib(max_epoch, dataset_train, model, random_ids_multi_super_iterations, sorted_ids_multi_super_iterations, delta_data_ids, batch_size, learning_rate_all_epochs, criterion, optimizer, para_list_all_epochs, gradient_list_all_epochs, is_GPU, device, record_params)
    ...
    delta = delta_data_ids.shape[0]*1.0*0.01/dataset_train.data.shape[0]
