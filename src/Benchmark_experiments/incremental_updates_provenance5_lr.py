...
#     print("learning rate::", alpha)
    ...
    res_para_list = torch.load(git_ignore_folder + 'res_para_list')
    
    res_grad_list = torch.load(git_ignore_folder + 'res_grad_list')
