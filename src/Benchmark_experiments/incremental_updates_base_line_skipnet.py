...
def test_hessian(S_k_list, Y_k_list, para_list_all_epochs2, gradient_list_all_epochs2):
    
    
    for i in range(len(S_k_list) - 1):
        print(torch.dot(get_all_vectorized_parameters(S_k_list[i]).view(-1) - get_all_vectorized_parameters(para_list_all_epochs2[i]).view(-1), get_all_vectorized_parameters(Y_k_list[i]).view(-1) - get_all_vectorized_parameters(gradient_list_all_epochs2[i]).view(-1)))
...
#     beta = torch.load(git_ignore_folder + 'beta')
    ...
    all_ids_list_all_epochs = torch.load(git_ignore_folder + "all_ids_list_all_epochs")
    
#     ids2_list_all_epochs = torch.load(git_ignore_folder + "ids2_list_all_epochs")
...
#     delta_data_ids = torch.tensor([random_ids_multi_super_iterations[1][1]])
...
#     para_list_all_epochs2 = torch.load(git_ignore_folder + 'expected_gradient_list_all_epochs')
#       
#     gradient_list_all_epochs2 = torch.load(git_ignore_folder + 'expected_para_list_all_epochs')
    
    
#     test_hessian(para_list_all_epochs, gradient_list_all_epochs, para_list_all_epochs2, gradient_list_all_epochs2)
...
#     torch.save(batch_num, git_ignore_folder + 'batch_num')
    ...
    test_skipnet(model, data_test_loader, criterion, len(dataset_test), is_GPU, device)
